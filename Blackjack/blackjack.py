...
def restart_game():
    global player_hand, dealer_hand, player_card_frame, dealer_card_frame, cards, deck
    player_hand.clear()
    dealer_hand.clear()
...
restart_button = tkinter.Button(button_frame, text="Restart", command=restart_game)
...
# create a list to hold player and dealer hands
dealer_hand = []
player_hand = []
starting_hands()
